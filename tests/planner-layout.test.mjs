...
assert.match(html, /\.planner-card-todo \.add-row \.area-picker\{[^}]*grid-column:2[^}]*width:max-content[^}]*max-width:min\(48vw,180px\)[^}]*min-height:40px/, "mobile Todo picker follows its label until the real viewport bound")
