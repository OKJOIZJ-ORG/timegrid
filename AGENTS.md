...
Verified production baseline (2026-09-06): v3.14.10 (runtime commit `093510c525e8dad90578c8b1ed459e716d041290`, published on `main` at `8a3ff3c9d8f7e49515b08cf31b86561b8bedf13e`).
- TimeGrid v3.14.10 deployed through Pages run 34038822643; all six public runtime assets exactly match Git bytes. The mobile Todo composer uses one grid row whose Area / Activity picker owns intrinsic content width while the title input owns the remainder; only genuinely long labels meet the viewport bound. Preserve the one-line composer, desktop layout and picker semantics. All 28 Node programs and four real-bootstrap contexts passed; the new 390px regression proves `공부 · 정치와 법` is fully visible with no page overflow. Native iPhone/WebKit and authenticated multi-device E2E remain unverified. Evidence: `RELEASE-2026-09-06-V3.14.10.md`.
