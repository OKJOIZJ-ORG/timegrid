...
Verified production baseline (2026-09-03): v3.14.1 (release commit `7f168edf7a2fd68bf3836cbcf23d0e9376e5295b`).
- Public index blob `ab143b307f8d074b2317bbe7c01da2513ff27269`; SW blob `2f7cdf46a5dffac8bc9421ad4c204b049fd912b9`; cache `timegrid-v3.14.1-20260903`. All six runtime assets match public bytes; Pages33766512119 succeeded.21 app programs and16 new continuity cases passed. Automation0.15.1 report and idle-reloaded receiver passed strict health. Evidence: `../TimeGridAutomation/memory/knowledge/live-continuity-coaching-20260903.md`. Existing protocol-2 rules/migration remain unchanged; prior conservation evidence stays in `catalog-lifecycle-20260903.md`.
