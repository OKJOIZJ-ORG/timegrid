...
Verified production baseline (2026-09-06): v3.14.8 (main commit `ca1ebfa457efe952bd5c589fa795a1e59a50bffc`).
- Pages run `34018906369` succeeded and six public runtime assets matched Git bytes. Cache `timegrid-v3.14.8-20260906`; 131 Node checks, four real-bootstrap contexts, delayed passive upgrade/reload and actual long-stream causal comparison passed. The affected authenticated Chrome tab was safely migrated and verified twice: controller v3.14.8, no waiting worker/banner, login and total preserved. Native iPhone/WebKit and authenticated multi-device E2E remain unverified. Evidence: `RELEASE-2026-09-06-V3.14.8.md`; earlier release reports remain historical. No Automation runtime or protocol-2 change in this PWA release.
