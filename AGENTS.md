...
Verified production baseline (2026-09-04): v3.14.3 (release commit `fbe79804c5774c1b979cd83dbf3394594a35e27b`).
- Public index blob `39cd165267d61aa71acce59eef578e9a8d13e1f1`; SW blob `a2351f10d6567bddcc2ecf1fa2f7b277fa48b717`; cache `timegrid-v3.14.3-20260904`. All six runtime assets match public bytes; Pages33859824841 succeeded.22 app programs,29 transaction cases and8 timer/ack cases passed;390px touch and1280px desktop with/without GSAP plus independent rehearsal passed. Synthetic ack-to-button reaction was39–87ms in the final strict-metadata fixture, not measured phone/network latency. Native iPhone/WebKit and authenticated multi-device E2E were not executed. Evidence: `../TimeGridAutomation/memory/knowledge/stop-ack-lifecycle-20260904.md`. Existing protocol-2 rules/migration and Automation0.15.1 runtime remain unchanged; prior gesture, operational/conservation evidence stays in `mobile-sync-catalog-20260904.md`, `live-continuity-coaching-20260903.md` and `catalog-lifecycle-20260903.md`.
